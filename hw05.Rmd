...
```{r}
ggsave("/gapminder_Euro.png", plot = gapminder_Europe_gdpPercap)
```

```{r}

![path]("./gapminder_Europe_plotly.png")

```
```{r}
ggsave("gapminder_gdp_plotly.png", plot = gapminder_gdp_plotly, path = "https://github.com/STAT545-UBC-students/hw05-albina23/")
```
